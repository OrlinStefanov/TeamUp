...
namespace TeamUpBackEnd.Migrations
{
    ...
    [Migration("20260618120639_AddMessageLikes")]
    partial class AddMessageLikes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Auth.EmailVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Chat.MessageLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Inbox.WorkspaceInboxDismissed", b =>
                {
                    b.Property<int>("WorkspaceId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("WorkspaceId", "UserId", "MessageId");
                    ...
                    b.ToTable("WorkspaceInboxDismissed");
                });
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Inbox.WorkspaceInboxLastSeen", b =>
                {
                    ...
                    b.Property<DateTime>("MemberLastSeen")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("TaskLastSeen")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Tasks.TaskItemTag", b =>
                {
                    b.Property<int>("TaskItemId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Chat.Conversation", b =>
                {
                    b.HasOne("TeamUpBackEnd.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Chat.MessageLike", b =>
                {
                    b.HasOne("TeamUpBackEnd.Models.Chat.Message", "Message")
                        .WithMany("Likes")
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Inbox.WorkspaceInboxDismissed", b =>
                {
                    b.HasOne("TeamUpBackEnd.Models.Inbox.WorkspaceInboxMessage", "Message")
                        .WithMany()
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TeamUpBackEnd.Models.Tasks.TaskItemTag", b =>
                {
                    b.HasOne("TeamUpBackEnd.Models.Tasks.Tag", "Tag")
